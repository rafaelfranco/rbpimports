...
$_['text_welcome']  = '<li class="login_h"><a href="%s"><i class="icon-lock"></i><span>Conectarse</span></a></li> <li><a href="%s"><i class="icon-file-alt"></i>Crear Cuenta</a></li>';
$_['text_logged']   = '<li class="login_h"><a href="%s"><i class="icon-unlock"></i><span>%s</span></a></li> <li><a href="%s"><i class="icon-file-alt"></i><span>Desconectar</span></a></li>';
