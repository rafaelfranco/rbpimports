  ...
  <div class="product-grid">
    <ul class="row">
      ...
      <div class="cart-button">
				<div class="cart"><a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button tooltip-2" title="<?php echo $button_cart; ?>"><i class="icon-shopping-cart"></i><span><?php echo $button_cart; ?></span></a></div>
...
function display(view) {
	if (view == 'list') {
		...
		$('.display').html('<b><?php echo $text_display; ?></b> <div id="list_b"><i class="icon-th-list"></i></div> <a id="grid_a" onclick="display(\'grid\');"><i class="icon-th-large"></i></a>');
		...
		$('.display').html('<b><?php echo $text_display; ?></b> <a id="list_a" onclick="display(\'list\');"><i class="icon-th-list"></i></a>  <div id="grid_b"><i class="icon-th-large"></i></i></div>');
