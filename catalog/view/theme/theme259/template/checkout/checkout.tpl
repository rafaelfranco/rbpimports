...
<div class="<?php if ($column_left or $column_right) { ?>span9<?php } ?> <?php if ($column_left and $column_right) { ?>span6<?php } ?> <?php if (!$column_right and !$column_left) { ?>span12 <?php } ?>" id="content"><?php echo $content_top; ?>
  ...
  <div class="checkout">
    <div id="checkout">
      <div class="checkout-heading hidden"><div class="marker-chekout"><?php echo $text_checkout_option; ?></div></div>
...
-->
    ...
    <div id="shipping-address">
      <div class="checkout-heading hidden">
      </div>
      <div class="checkout-content"></div>
    </div>
    ...
    <div id="payment-method">
      <div class="checkout-heading hidden"></div>
      <div class="checkout-content"></div>
    </div>
    <div id="confirm">
      <div class="checkout-heading hidden"></div>
...
$('#button-account').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-account').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme259/image/loading.gif" alt="" /></span>');
		},		
		complete: function() {
...
$('.backto1').live('click', function() {
	$('#shipping-address .checkout-content').slideDown('slow');
	$('#shipping-method .checkout-content').slideUp('slow');
	$('#payment-method .checkout-content').slideUp('slow');
});

$('.backto2').live('click', function() {
	$('#shipping-method .checkout-content').slideDown('slow');
	$('#payment-method .checkout-content').slideUp('slow');
});

$('.backto3').live('click', function() {
	$('#shipping-method .checkout-content').slideUp('slow');
...
$('#button-login').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-login').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme259/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-register').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-register').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme259/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if ($('#shipping-address input[name=\'numero\']').val() == '') {
					$('#shipping-address input[name=\'numero\'] + br').after('<span class="error">Preencha o número</span>');
				}						
...
$('#button-payment-address').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-payment-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme259/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme259/image/close-1.png" alt="" class="close" /></div>');
...
$('#button-shipping-address').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-shipping-address').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme259/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-address .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme259/image/close-1.png" alt="" class="close" /></div>');
...
$('#button-guest').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-guest').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme259/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-guest-shipping').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-guest-shipping').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme259/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
...
$('#button-shipping-method').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-shipping-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme259/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#shipping-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme259/image/close-1.png" alt="" class="close" /></div>');
...
$('#button-payment-method').live('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#button-payment-method').after('<span class="wait">&nbsp;<img src="catalog/view/theme/theme259/image/loading.gif" alt="" /></span>');
		},	
		complete: function() {
		...
		success: function(json) {
			...
			if (json['redirect']) {
				...
				if (json['error']['warning']) {
					$('#payment-method .checkout-content').prepend('<div class="warning" style="display: none;">' + json['error']['warning'] + '<img src="catalog/view/theme/theme259/image/close-1.png" alt="" class="close" /></div>');
