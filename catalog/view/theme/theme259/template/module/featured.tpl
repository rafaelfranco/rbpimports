			...
			<li class="<?php echo $a. $last_line ;?> span<?php echo $spanLine ;?>">
						...
						<div class="wrapper marg row-fluid">
							...
							<div class="right span8">
								...
								<div class="cart-button">
									<div class="cart">
										<a title="<?php echo $button_cart; ?>" data-id="<?php echo $product['product_id']; ?>;" class="button addToCart-1 tooltip-2">
									...
									<div class="wishlist">
										<a class="tooltip-2" title="<?php echo $button_wishlist; ?>"  onclick="addToWishList('<?php echo $product['product_id']; ?>');">
											<i class="icon-star"></i>
											<span><?php echo $button_wishlist; ?></span>
										</a>
									</div>
									<div class="compare">
										<a class="tooltip-2" title="<?php echo $button_compare; ?>"  onclick="addToCompare('<?php echo $product['product_id']; ?>');">
								...
								<div class="clear"></div>
								<div class="rating">
									<img height="18" src="catalog/view/theme/theme259/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
								</div>
							</div>
						</div>
				...
				<div class="inner">
					<div class="f-left">
						...
						<div class="description"><?php echo mb_substr($product['description1'],0,79,'UTF-8').'...';?></div>
						<?php } ?>
					...
					<div class="cart-button">
						...
						<div class="cart"><a title="<?php echo $button_cart; ?>" data-id="<?php echo $product['product_id']; ?>;" class="button addToCart tooltip-2"><i class="icon-shopping-cart"></i><span><?php echo $button_cart; ?></span></a></div>
