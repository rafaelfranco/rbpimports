<?php if (count($languages) > 1) { ?>
  ...
  <div id="language" class="header-button">
		<div class="heading"><?php echo $text_language1; ?><i class="icon-sort-down"></i></div>
		<div class="heading1"><i class="icon-globe"></i><?php echo $text_language; ?><i class="icon-sort-down"></i></div>
		<ul>
