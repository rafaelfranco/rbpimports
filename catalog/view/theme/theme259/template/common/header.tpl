...
<link href='https://fonts.googleapis.com/css?family=Open+Sans:300,400,700,600&subset=latin,cyrillic-ext,greek-ext,greek,vietnamese,latin-ext,cyrillic' rel='stylesheet' type='text/css'>
...
<script type="text/javascript" src="catalog/view/theme/<?php echo $this->config->get('config_template');?>/js/rbpimports.js"></script>
					...
					<ul  class="menu">
						...
						<div>
								...
								<?php $id=$category['children'][$i]['category_id'];?>
									...
									if( $id == $child_id && $k == 1)
									{?><li class="active"><?php ;}
									elseif ( $id == $child_id && $k > 1 )
									{?><li class="active big"><?php ; }
									elseif ( $id != $child_id && $k == 1 )
									{?><li><?php ;}
									elseif( $id != $child_id && $k > 1 )
									{?><li class="big"><?php ; }							
