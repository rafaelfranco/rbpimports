...
$(document).ready(function() {		
	if ($('#menu').height() > 61) {
					$('#menu>ul>li>a').css({fontSize:'10px',paddingLeft:'6px',paddingRight:'6px'});
				} 
}); 
/**********************************************************prettyphoto*****************************************************************************/
    $(document).ready(function(){
...
jQuery("#menu-icon").on("click", function(){
  ...
  jQuery('.sf-menu-phone').find('li.parent').append('<i class="icon-caret-down"></i>');
...
/******************************************************Aside box category**************************************************************************************/
$(document).ready(function(){
		jQuery('.box .box-category').find('li.parent').prepend('<i class="icon-sort-down"></i>');
