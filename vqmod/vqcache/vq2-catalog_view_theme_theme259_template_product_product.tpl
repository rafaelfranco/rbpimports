		...
		<div class="prod-row">
			<div class="cart-top">
				<div class="cart-top-padd form-inline">
					...
					<a id="button-cart" class="button-prod" ><i class="icon-shopping-cart"></i><span>
			...
			echo $button_carts;
				...
				<div class="extra-button">
					<div class="wishlist">
						<a class="tooltip-2"  onclick="addToWishList('<?php echo $product_id; ?>');" title="<?php echo $button_wishlist; ?>"><i class="icon-star"></i><span><?php echo $button_wishlist; ?></span></a>
					</div>
					<div class="compare">
						<a class="tooltip-2"  onclick="addToCompare('<?php echo $product_id; ?>');" title="<?php echo $button_compare; ?>"><i class="icon-bar-chart"></i><span><?php echo $button_compare; ?></span></a>
					</div>
				</div>
				<div class="clear"></div>
				<?php if ($minimum > 1) { ?>
...
<?php
		...
		<div class="review">
			<div>
				<img src="catalog/view/theme/theme259/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />&nbsp;&nbsp;
				<div class="btn-rew">
	...
	<div class="box-product"> 
		<ul class="related-slider">
			...
			"<?php echo $button_cart_main; ?>"
			 onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button tooltip-2">
			...
			<?php if ($product['rating']) { ?>
				<img height="13" src="catalog/view/theme/theme259/image/stars-<?php echo $product['rating']; ?>.png" alt="<?php echo $product['reviews']; ?>" />
			<?php } ?>
			</div></div>
			</li>
			<?php } ?>
...
new AjaxUpload('#button-option-<?php echo $option['product_option_id']; ?>', {
	...
	onSubmit: function(file, extension) {
		$('#button-option-<?php echo $option['product_option_id']; ?>').after('<img src="catalog/view/theme/theme259/image/loading.gif" class="loading" style="padding-left: 5px;" />');
...
$('#button-review').bind('click', function() {
	$.ajax({
		...
		beforeSend: function() {
			...
			$('#review-title').after('<div class="attention"><img src="catalog/view/theme/theme259/image/loading.gif" alt="" /> <?php echo $text_wait; ?></div>');
		},
		complete: function() {
